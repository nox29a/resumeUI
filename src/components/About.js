      ...
      <div className='container mx-auto'>
        <h1 data-aos="flip-down" className='text-[90px] text-center p-8 gap-4'>About</h1>
            <div className='text-lg grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-8 gap-20'>
              {/* <img src={Portret} alt='portret' className='absolute h-1/2' /> */}
              <p data-aos="fade-right" className='bg-hero border-4 border-purple-700 text-xl rounded-lg p-8 '><img src={Portret} alt='portret' className='w-fit' /></p>
