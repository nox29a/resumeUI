      ...
      <div className='container mx-auto'>
        <h1 className='text-[90px] text-center p-8 gap-4'>About me</h1>
            <div className='text-lg grid grid-cols-1 md:grid-cols-2  p-8 gap-20 '>
              <p className='bg-hero border-4 border-purple-700 text-xl rounded-lg p-8 '>I'm excited to be starting my journey in web development. While I may not have any professional experience yet, I am passionate about learning and developing my skills in this field.</p>
