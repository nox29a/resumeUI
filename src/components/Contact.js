    ...
    <div className='grid place-items-center'>
      <div className='container'>
        <div className='text-[30px] text-center p-8 gap-4 mt-20'>
          ...
          <p className=' mb-12 lg:96 sm:mx-5 md:mx-32  p-4 bg-purple-400 hover:bg-blue-700 text-white  border-2 border-purple-700 rounded-full'>adamczyk29a@interia.pl</p>
