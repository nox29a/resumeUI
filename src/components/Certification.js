...
<div id='Certification' className='bg-hero grid place-items-center pt-32'>
      <div className='container mx-auto'>
            <h1 data-aos="flip-down" className='text-[90px] text-center p-8 gap-4'>Certifications</h1>
            <div className='text-lg grid md:grid-cols-2 lg:grid-cols-3 p-8 gap-20 '>
                  ...
                  <div data-aos="flip-up" className='bg-certification border-4 border-purple-700 rounded-lg p-8 flex flex-col items-center h-96 hover:border-purple-500'><div className='text-center mb-12 lg:mb-5'>Responsive web design</div>
                  ...
                  <div data-aos="flip-up" className='bg-certification border-4 border-purple-700 rounded-lg p-8  flex flex-col items-center h-96 hover:border-purple-500'><div className='text-center mb-5'>Javascript algorithms and data structures</div>
                  ...
                  <div data-aos="flip-up" className='bg-certification border-4 border-purple-700 rounded-lg p-8 flex flex-col items-center h-96 hover:border-purple-500'><div className='text-center mb-5'>Front end development libraries</div>
